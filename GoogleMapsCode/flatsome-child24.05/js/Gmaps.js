...
function initMap() {
  ...
  if(getAllUrlParams().destination != null){
  ...
  //map style settings, currently set to turn off all of Google's points of interest (poi)
    ...
    if(this.destination != null){
      routeMarkers(this.destination, this.iconTypes['endPoint'], 'Destination', this.map);
    ...
    console.log("Search Radius: "+this.searchRadius+"m");
};
